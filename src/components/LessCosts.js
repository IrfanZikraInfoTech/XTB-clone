        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2 bg-white rounded-3xl p-10 shadow-xl">
            <div className="flex justify-center">
              {/* Visual Elements */}
              <img src="/kv-s1-dekstop-a-0-commision.png" alt="0% commission" className="w-full h-full" />
            </div>
          ...
          <div className="md:col-span-1.5 bg-white rounded-3xl p-10 shadow-xl">
            {/* Visual Elements */}
            <div className="flex justify-center">
              <img src="/kv-s1-dekstop-b-withdrawals.png" alt="Free deposits and withdrawals" className="w-full h-full" />
            </div>
          ...
          <div className="md:col-span-1.5 bg-white rounded-3xl p-10 shadow-xl">
            {/* Visual Elements */}
            <div className="flex justify-center">
              <img src="/kv-s1-dekstop-c-account.png" alt="Free account opening" className="w-full h-full" />
            </div>
